...
export const getSystemPrompt = (
  ...
  IMPORTANT: remember to give suggestions using ordered list format at the end of your response.
  ...
  Please return answer in markdown. It is very important for my career that you follow these instructions. 

  IMPORTANT: remember to give suggestions using ordered list format at the end of your response.

  Here is the topic to educate on:
    `;
};
